...
```{r, echo=FALSE}
data.frame("Random Forest" = conf1$overall[1], "Recursive Partitioning" = conf3$overall[1], "Linear Discriminant Analisys" = conf3$overall[1])
```
The model showed the best accuracy with 29 predictors:
```{r}
